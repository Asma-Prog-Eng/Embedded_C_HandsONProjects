Bare metal implementation  of a Systick Interrupt driver for STM32 development board 
## Features
- Systick initialization with system clock = 8MHz.
- Toggle user LED3 (PD13) every 1s
...
1. Clone this repository:
   ```bash
   git clone https://github.com/Asma-Prog-Eng/Systick_Interrupt_Driver
