...
| **[`SPI_ADXL345_DRIVER`](./SPI_ADXL345_DRIVER/)** | *ADXl345 accelerometer data monitoring using SPI | *STM32F411x  / ARM Cortex-M4* |
| **[`PLL_SYSCLK_HSI`](./PLL_SYSCLK_HSI/)** | *SYSCLK Configuration using PLL | *STM32F103 / ARM Cortex-M3* |
| **[`SYSCLK_Driver`](./SYSCLK_Driver/)** | *SYSCLK Driver Implementation in polling mode| *STM32F103 / ARM Cortex-M3* |
| **[`Systick_Interrupt_Driver`](./Systick_Interrupt_Driver/)** | *Super Loop Systick Driver Implementation| *STM32F103 / ARM Cortex-M3* |
| **[`TIM2-HAL-Interrupt-Overhead-Benchmark`](./TIM2-HAL-Interrupt-Overhead-Benchmark/)** | *Timer 2 Driver in Dual Channel mode Implementation I| *STM32F103 / ARM Cortex-M3* |
| **[`Timer_Driver`](./Timer_Driver/)** | *Bare Metal Timer 2 Driver Implementation | *STM32F411x  / ARM Cortex-M4* |
| **[`Timer_Interrupt_Driver`](./Timer_Interrupt_Driver/)** | *Bare Metal Timer 2 Driver with Interrupt Handling Implementation I| *STM32F411x  / ARM Cortex-M4* |
