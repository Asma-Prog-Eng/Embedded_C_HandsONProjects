 ...
 *  SYSCLK as 36 , 40, 52 and 60 MHZ.
 *  Default SYSCLK Freq = 36MHz.
 *  And deduce APB1 , APB2 and AHB from it.
...
int main(void){
	...
	SYSCLK_Config_HSE(SYS_CLOCK_FREQ_36MHZ);
...
void SYSCLK_Config_HSE(uint8_t clock_freq) {
